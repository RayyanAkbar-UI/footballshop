...
from main.views import create_items, show_main, show_product, show_xml, show_json, show_json_by_id, show_xml_by_id, delete_item, register, login_user, logout_user, show_shop, edit_product
